...
class Car : Test
{
    this()
    {
        ...
        // Teeter
        {
            ...
            body_.CreateFixture(box, 1.0f);

            b2RevoluteJointDef jd = new b2RevoluteJointDef();
            jd.Initialize(ground, body_, body_.GetPosition());
            jd.lowerAngle  = -8.0f * b2_pi / 180.0f;
            jd.upperAngle  = 8.0f * b2_pi / 180.0f;
            jd.enableLimit = true;
            m_world.CreateJoint(jd);

            body_.ApplyAngularImpulse(100.0f, true);
        }
        ...
        // Bridge
        {
            ...
            for (int32 i = 0; i < N; ++i)
            {
                ...
                b2Vec2 anchor = b2Vec2(160.0f + 2.0f * i, -0.125f);
            ...
            b2Vec2 anchor = b2Vec2(160.0f + 2.0f * N, -0.125f);
        ...
        // Car
        {
            ...
            m_spring1         = enforce(cast(b2WheelJoint)m_world.CreateJoint(jd));
            ...
            jd.frequencyHz    = m_hz;
            jd.dampingRatio   = m_zeta;
            m_spring2         = enforce(cast(b2WheelJoint)m_world.CreateJoint(jd));
        }
    }
