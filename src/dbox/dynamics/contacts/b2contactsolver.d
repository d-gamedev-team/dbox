...
struct b2ContactSolver
{
    ...
    this(b2ContactSolverDef* def)
    {
        ...
        for (int32 i = 0; i < m_count; ++i)
        {
            ...
            vc.indexA       = body_A.m_islandIndex;
            vc.indexB       = body_B.m_islandIndex;
            vc.invMassA     = body_A.m_invMass;
            vc.invMassB     = body_B.m_invMass;
            vc.invIA        = body_A.m_invI;
            vc.invIB        = body_B.m_invI;
            vc.contactIndex = i;
            ...
            b2ContactPositionConstraint* pc = m_positionConstraints + i;
            pc.indexA       = body_A.m_islandIndex;
            pc.indexB       = body_B.m_islandIndex;
            pc.invMassA     = body_A.m_invMass;
            pc.invMassB     = body_B.m_invMass;
            pc.localCenterA = body_A.m_sweep.localCenter;
            pc.localCenterB = body_B.m_sweep.localCenter;
            pc.invIA        = body_A.m_invI;
            pc.invIB        = body_B.m_invI;
